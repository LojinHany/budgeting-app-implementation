...
/**
 * This is the main class for the Nazamha (Budgeting Application) that facilitates user authentication, 
 * management of categories, expenses, transactions, reminders, and budget analysis.
 * It also provides the user interface for interacting with the application.
 */
public class App {

    /**
     * The entry point of the application, handling user authentication, and providing the main menu 
     * for performing various tasks such as adding categories, tracking expenses, managing transactions, 
     * and managing reminders and settings.
     *
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("7- Track Transactions");
            System.out.println("8- Budget Analysis");
            System.out.println("9- Manage Settings");
            ...
            switch (choice) {
                ...
                case "7":
                    // Track Expenses
                    budgetManager.trackTransactions();
                    break;
                case "8":
                    // Budget Analysis
                ...
                case "10":
                    ...
                    System.exit(0);
                default:
                    System.out.println("Invalid! Please enter a valid number (1-10)");
            }
        }
    }
}
